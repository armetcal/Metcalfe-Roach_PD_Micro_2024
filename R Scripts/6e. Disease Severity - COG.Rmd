...
ggsave('../Results/Supplementary Figures/Fig. 4d - COG vs Disease Severity - Univar.png',height=20,width=9)

# Multivar
ggarrange(plotlist = list(p))
ggsave('../Results/Supplementary Figures/Fig. 4d - COG vs Disease Severity - Multivar.png',height=20,width=9)
```
...
writexl::write_xlsx(list('Univar' = spearman,
                    ...
                    '../Results/Supplementary Data/Progression/COG vs Baseline Severity Stats.xlsx')
```