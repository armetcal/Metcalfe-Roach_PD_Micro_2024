...
p_out
ggsave('../Results/Figures/Figure 1 - Microbial Network Analysis.tiff', height = 8.5, width = 12)
```
...
ggsave('../Results/Supp Figures/Figure S1 - Network and Betweenness Centrality Phylum.tiff', height = 5, width = 17)
```
