---
title: "6d. Disease Severity - Species - Fig 4c"
...
ggsave('../Results/Supplementary Figures/Fig. 4c - Species vs Disease Severity - Univar.png', height=6,width=8)

# Multivar
ggarrange(plotlist = list(p))
ggsave('../Results/4. Progression/Fig. 4c - Species vs Disease Severity - Multivar.png',height=6,width=8)
```
...
writexl::write_xlsx(list('Univar' = spearman,
                    ...
                    '../Results/Supplementary Data/Progression/Species vs Baseline Severity Stats.xlsx')
```